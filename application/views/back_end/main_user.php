...
<td>' . $r -> name . '</td>
<td>' . $r -> user_state . '</td>
<td><a class="btn btn-info"  href="' . base_url() . 'user/edit/' . $r -> user_id . '">Sửa</a></td>
<td><a class="btn btn-danger" href="' . base_url() . 'user/?action=delete&id=' . $r -> user_id . '">Xóa</a></td>
</tr>';
								}
							}
							?>
