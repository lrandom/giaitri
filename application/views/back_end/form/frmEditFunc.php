			...
			<fieldset>
				...
				<form class="form-horizontal" id="form-add-app" method="post">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="txtName" name="txtName" placeholder="Tên" value="<?php echo isset($txtName)?$txtName:$func[0]->desc ?>"/>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="txtCode" name="txtCode" placeholder="Mã code" value="<?php echo isset($txtCode)?$txtCode:$func[0]->code ?>"/>
						</div>
					</div>
