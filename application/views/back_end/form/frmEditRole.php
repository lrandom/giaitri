			...
			<fieldset>
				...
				<form class="form-horizontal" id="form-add-role" method="post">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="txtRole" name="txtRole" placeholder="Tên vai trò" value="<?php echo isset($txtRole)?$txtRole:$role[0]->name ?>"/>

						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="txtRole">Trạng thái</label>
						<div class="controls">
					...
					<div class="control-group">
						<div class="controls">
							<input type="submit" value="Sửa" class="btn"/>
							<a href="<?php echo base_url().'admin/role' ?>" class="btn"> Quay lại </a>
						</div>
					</div>
				</form>
			</fieldset>
